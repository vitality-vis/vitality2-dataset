...
def download_and_decompress_xml(output_dir: Path, xml_gz_url: str, keep_gz: bool) -> Path:
    ...
    try:
        download_file(xml_gz_url, gz_tmp)
...
def main() -> int:
    ...
    if not args.dtd_only:
        download_and_decompress_xml(args.output_dir, args.xml_url, args.keep_gz)
